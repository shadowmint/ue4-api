...
namespace api {
  ...
  class Debug {
    public:
      ...
      /// Usage:
      ///
      ///   Debug::trace(this, FString::Printf(TEXT("%s"), TEXT("Hello World")));
      ///
      ...
      /// Usage:
      ///
      ///   Debug::trace(this, "%s", "Hello World");
      ///   Debug::trace(context, "Found an actor: %s", Debug::as_str(ActorItr->GetName()));
      ///
